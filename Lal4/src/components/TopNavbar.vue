...
<template>
  <nav class="py-2 fixed-top">
    <div name="top" class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        <li class="nav-item"><router-link to="/" class="nav-link px-2 active" aria-current="page">
          <a href="#top" class="nav-link px-2"><img src="/images-cloud/home_page.svg" alt="home_page link" width="30" height="30" class="rounded-circle"></a>
        </router-link></li>
        <li class="nav-item"><a href="#new-arrivals" class="nav-link px-2">Новые поступления</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Цены</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">FAQs</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">О компани</a></li>
      </ul>
